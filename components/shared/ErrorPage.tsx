...
import { BasisTheoryLogoWithTextBw } from '@/components/shared/BasisTheoryLogoWithTextBw';
            ...
            <Toolbar>
              ...
              >
                ...
                <Box display="flex" flexDirection="row">
                  ...
                  <Box px={1}>
                    <Button href="https://docs.basistheory.com/" variant="text">
                      {tc('documentation')}
                    </Button>
                  </Box>
                </Box>
